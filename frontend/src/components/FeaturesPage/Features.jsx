...
const Features = () => {
    return (
        ...
        <div className="features-container">
          <h1>Key Features</h1>
          <ul className="outer">
            <li className="outerli"><span>Feature 1:</span> Input by Link <br /> 
            ...
            <li className="outerli"><span>Feature 2:</span> Input by CSV<br />
            ...
            <li className="outerli"><span>Feature 3:</span> Dashboard with Visualized Representation of Sentiment Analysis<br />
            ...
            <li className="outerli"><span>Feature 4:</span> Download Report Feature<br />
