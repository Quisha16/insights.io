...
from .views import form_submit, dashboard, get_customer_rating, get_customer_overtime_sentiment, get_customer_overtime_positive_sentiment, get_sentiment_prediction, get_aspects, get_sentiment_info
urlpatterns = [
    ...
    path('sentiment_info/', get_sentiment_info, name='sentiment_info'),
